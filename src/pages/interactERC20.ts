...
const compiledErc20mintable = json.parse(fs.readFileSync("compiled_contracts/ERC20ETH.json").toString("ascii"));


const addrETH = "0x049d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7";
const erc20Address = addrETH
const erc20 = new Contract(compiledErc20mintable.abi, addrETH, provider);
